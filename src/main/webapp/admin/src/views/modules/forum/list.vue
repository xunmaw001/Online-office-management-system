...
|| (sessionTable == 'jingli' && scope.row.jingliId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xianshangbangongguanlixitong/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.bumenTypes = el.bumenTypes;
                            forum.zhiweiTypes = el.zhiweiTypes;
                            forum.createTime = el.createTime;
                            forum.jingliId = el.jingliId;//---
                            forum.jingliUuidNumber = el.jingliUuidNumber;
                            forum.jingliName = el.jingliName;
                            forum.jingliPhone = el.jingliPhone;
                            forum.jingliIdNumber = el.jingliIdNumber;
                            forum.jingliPhoto = el.jingliPhoto;
                            forum.jingliEmail = el.jingliEmail;
                            forum.createTime = el.createTime;

    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="扣减" prop="koujianJine">
                       <el-input v-model="ruleForm.koujianJine"
                                 placeholder="扣减" clearable  :readonly="ro.koujianJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="扣减" prop="koujianJine">
                           <el-input v-model="ruleForm.koujianJine"
                                     placeholder="扣减" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   koujianJine: [
                              { required: true, message: '扣减不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }

...
//                            chuqinEntity.setYonghuId(Integer.valueOf(data.get(0)));   //员工 要改的
//                            chuqinEntity.setOnTime(sdf.parse(data.get(0)));          //上班打卡时间 要改的
//                            chuqinEntity.setDownTime(sdf.parse(data.get(0)));          //下班打卡时间 要改的

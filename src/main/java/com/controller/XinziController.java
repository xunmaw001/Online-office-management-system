    ...
    */
    ...
    public R save(@RequestBody XinziEntity xinzi, HttpServletRequest request){
        ...
        if(xinziEntity==null){
            ...
            xinzi.setShifaJine(xinzi.getJibenJine()+xinzi.getJiangjinJine()+xinzi.getButieJine()+xinzi.getJixiaoJine()-xinzi.getKoujianJine());
...
//                            xinziEntity.setYonghuId(Integer.valueOf(data.get(0)));   //员工 要改的
...
//                            xinziEntity.setKoujianJine(data.get(0));                    //扣减 要改的

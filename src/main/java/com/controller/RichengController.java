...
//                            richengEntity.setRichengName(data.get(0));                    //日程名称 要改的
//                            richengEntity.setRichengTypes(Integer.valueOf(data.get(0)));   //日程类型 要改的
//                            richengEntity.setRichengContent("");//详情和图片
//                            richengEntity.setZhixingTime(sdf.parse(data.get(0)));          //日程执行时间 要改的
//                            richengEntity.setYizuoTypes(Integer.valueOf(data.get(0)));   //已做未做 要改的
//                            richengEntity.setInsertTime(date);//时间

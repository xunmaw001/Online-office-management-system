    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                //级联表
                JingliEntity jingli = jingliService.selectById(forum.getJingliId());
                if(jingli != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setJingliId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("jingli_id", forum.getJingliId())
...
//                            forumEntity.setYonghuId(Integer.valueOf(data.get(0)));   //员工 要改的
//                            forumEntity.setJingliId(Integer.valueOf(data.get(0)));   //经理 要改的

...
public class XinziEntity<T> implements Serializable {
     ...
     * 扣减
     */
    @TableField(value = "koujian_jine")

    private Double koujianJine;
    ...
    public void setKoujianJine(Double koujianJine) {
        this.koujianJine = koujianJine;
    }
    /**
	 * 设置：实发
	 */
